...
public class OneToManyBoot {
	...
	public static void main(String[] args) {
		...
		try {
			...
			nativeQuery(em, "SHOW COLUMNS FROM EntityA00_EntityA01");
	...
	private static void persistEntities(EntityManager em) {
		...
		EntityA00 a = new EntityA00();
		EntityA01 b = new EntityA01();
		EntityA01 b1 = new EntityA01();
	...
	private static void loadEntityA(EntityManagerFactory emf) {
		...
		List<EntityA00> entityAList = em.createQuery("Select t from EntityA000 t").getResultList();
	...
	private static void loadEntityB(EntityManagerFactory emf) {
		...
		EntityManager em = emf.createEntityManager();
		List<EntityA01> entityBList = em.createQuery("Select t from EntityA011 t").getResultList();
